...
document.querySelector(".weather-search").addEventListener("submit",e => {let search = document.querySelector(".weather-searchform");
...
function getWeather() {
  const API_KEY = "bb09341630842aee3e2554fabae4ea98";
  fetch(
